    ...
    return (
      ...
      <div className="container">
            <div className="content-box">
                  <div className="row">
                  <select onChange={this.apiSelect.bind(this)} class="form-control form-control-md">
        ...
        <div className="container">
          ...
          <div className="row">
          {this.state.requestAndResponseBox == true ? 
            <div className="col-12 col-md-6 request-box">
                ...
                <p>{item.parameterDescription}</p><hr></hr>
                </div>
                )}
                </div>
            </div>
            ...
            {this.state.requestAndResponseBox == true ? 
            <div className="col-12 col-md-5 response-box">
                <h4>Response - 200</h4>
                <hr></hr>
                <div className="shift-button">
                <button className="btn btn-outline-light">Schema</button>&nbsp;<button className="btn btn-outline-light">Example</button>
                </div>
